...
struct AppData {
    ...
    */
    ...
    @Storage(key: "access_token", defaultValue: "")
    static var accessToken: String
//
//    @Storage(key: "refresh_token", defaultValue: "")
//    static var refresh_token: String
//
//    @Storage(key: "remember_me", defaultValue: false)
//    static var remember_me: Bool
//
//    @Storage(key: "is_live", defaultValue: false)
//    static var isLive: Bool
//
//    @Storage(key: "ref", defaultValue: 0)
//    static var code: Int
//
//    @Storage(key: "otp_ref", defaultValue: "")
//    static var otp_ref: String
